...
<div class="custom-container tip"><p class="custom-container-title">前往冒泡排序学习</p>
<p><strong><RouterLink to="/markdown/go%E8%AF%AD%E8%A8%80%E7%9A%84%E7%9A%84%E6%8E%92%E5%BA%8F%E5%92%8C%E6%9F%A5%E6%89%BE.html">冒泡排序是最基础的排序，也是时间复杂度最高的排序方法</RouterLink></strong></p>
<h2 id="选择排序" tabindex="-1"><a class="header-anchor" href="#选择排序" aria-hidden="true">#</a> 选择排序</h2>
<p><strong>从小到大，层层解析排序</strong></p>
...
<p><img src="@source/markdown/images/f8xmIhTgXNzSEZM.png" alt="image-20220408215647485"></p>
<p><strong>从大到小，使用Go - range 和sort包排序</strong></p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/markdown/images/N26PriUIvhj81Ca.png" alt="image-20220408215606660"></p>
<p><strong>使用sort包</strong></p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>PS C:\Users\smile\Desktop\区块链\code\chapter05\ifdemo> go run .\main2.go
...
<h3 id="_1-算法步骤" tabindex="-1"><a class="header-anchor" href="#_1-算法步骤" aria-hidden="true">#</a> 1. 算法步骤</h3>
...
<h3 id="_2-动图演示" tabindex="-1"><a class="header-anchor" href="#_2-动图演示" aria-hidden="true">#</a> 2. 动图演示</h3>
<p><img src="@source/markdown/images/GN7ZSp1vy9uRWs8.gif" alt="img"></p>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>[Running] go run "c:\Users\smile\Desktop\区块链\code\chapter04\demo03\main.go"
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="快速排序" tabindex="-1"><a class="header-anchor" href="#快速排序" aria-hidden="true">#</a> 快速排序</h2>
...
<p><img src="@source/markdown/images/Ne8Ppn3qlCGoaHu.gif" alt="img"></p>
<p><strong>代码实现</strong></p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
