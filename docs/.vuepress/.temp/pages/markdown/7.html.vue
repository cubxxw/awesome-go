<template><div><h1 id="数组和slice切片-遍历" tabindex="-1"><a class="header-anchor" href="#数组和slice切片-遍历" aria-hidden="true">#</a> 数组和slice切片&amp;遍历</h1>
...
<p><strong>3. 初始化数组中 <code v-pre>{}</code> 中的元素个数不能大于 <code v-pre>[]</code> 中的数字。</strong></p>
<p>如果忽略 <code v-pre>[]</code> 中的数字不设置数组大小，Go 语言会根据元素的个数来设置数组的大小：</p>
