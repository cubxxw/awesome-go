<template><div><ul>
<li><a href="https://github.com/cubxxw/MIT6.824-DistributedSystem" target="_blank" rel="noopener noreferrer">🔥 开源地址<ExternalLinkIcon/></a></li>
</ul>
...
<br>
<blockquote>
<p>❤️💕💕⚠️ According to the MIT 6.824 Collaboration policy, which prevents students from obtaining Solutions through GitHub, the source repository is for personal use only, and the documentation uses an open source protocol for learning. Myblog:<a href="http://nsddd.top/" target="_blank" rel="noopener noreferrer">http://nsddd.top<ExternalLinkIcon/></a></p>
</blockquote>
<hr>
<nav class="table-of-contents"><ul><li><router-link to="#end-链接">END 链接</router-link></li></ul></nav>
<p>[TOC]</p>
<h1 id="mapreduce基本工作方式" tabindex="-1"><a class="header-anchor" href="#mapreduce基本工作方式" aria-hidden="true">#</a> MapReduce基本工作方式</h1>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDIyD6H77qUPZfWGjIo%2F-MDJ9wJWWhCPbyx1XJ7T%2Fimage.png?alt=media&amp;token=39c7fc55-f19a-427e-8b70-f76c47d9f366" alt="img"></p>
<p>MapReduce启动时，会查找Map函数。之后，MapReduce框架会为每个输入文件运行Map函数。这里很明显有一些可以并行运算的地方，比如说可以并行运行多个只关注输入和输出的Map函数。</p>
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDIyD6H77qUPZfWGjIo%2F-MDJAEJOBpdAOBgS6ONi%2Fimage.png?alt=media&amp;token=ef4f5796-ccf4-4176-bfbb-78e18a5990c1" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDIyD6H77qUPZfWGjIo%2F-MDJCIHw5xEjErDGUwg0%2Fimage.png?alt=media&amp;token=242d8247-c6ee-423b-a80f-73a8f9b685f0" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMNyDk-zmwaD9kvov1%2F-MDMS2JAhAoGaraFmIYK%2Fimage.png?alt=media&amp;token=307adb73-eb4c-43a2-9bef-847600403da7" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMNyDk-zmwaD9kvov1%2F-MDMTcGmdnhYPCDS2dpc%2Fimage.png?alt=media&amp;token=c35deef6-512c-4cff-a711-35b39ea977d9" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMNyDk-zmwaD9kvov1%2F-MDMVik1sf9kZLPEawuK%2Fimage.png?alt=media&amp;token=3131d750-40c0-40ca-bfe9-fe002ac30f3b" alt="img"></p>
...
<h1 id="map函数和reduce函数" tabindex="-1"><a class="header-anchor" href="#map函数和reduce函数" aria-hidden="true">#</a> Map函数和Reduce函数</h1>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMXTr58UU0Viim9EbH%2F-MDM_1yjuBd7yzvg5Lcp%2Fimage.png?alt=media&amp;token=303356e8-e8ca-408f-a2e2-b442e2471051" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMXTr58UU0Viim9EbH%2F-MDMc7kqC0eAjwQLIu7Q%2Fimage.png?alt=media&amp;token=c127778b-a9f8-4712-a87f-f668c6558a57" alt="img"></p>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDMXTr58UU0Viim9EbH%2F-MDMujLf7XmFTWVn6CKB%2Fimage.png?alt=media&amp;token=7a27e667-0616-4088-94d2-66749b8de08d" alt="img"></p>
<blockquote>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDN6mwa8H8nyhZDCGAy%2F-MDPZnntD2OS6SenFwGk%2Fimage.png?alt=media&amp;token=64a469be-250a-4d10-bb19-89cbc0347628" alt="img"></p>
<blockquote>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDN6mwa8H8nyhZDCGAy%2F-MDPfXpADnUuC04cOzkH%2Fimage.png?alt=media&amp;token=f88a24a0-d08c-4492-86a1-c89ff6caf9fe" alt="img"></p>
<blockquote>
<p>而我们最终需要这些数据在运行Reduce函数的机器上按照列存储（例如，Reduce函数需要的是第一个Map函数的a=1和第三个Map函数的a=1）。</p>
</blockquote>
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDN6mwa8H8nyhZDCGAy%2F-MDPfhJdQXgqjxktOy1E%2Fimage.png?alt=media&amp;token=7f032531-fb8d-463f-a1c9-343de1056138" alt="img"></p>
<blockquote>
...
<p><img src="https://906337931-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-MAkokVMtbC7djI1pgSw%2F-MDN6mwa8H8nyhZDCGAy%2F-MDPo5GjZT0JbipeZrJn%2Fimage.png?alt=media&amp;token=3010b3b3-a19c-4e21-88b8-05dea250accc" alt="img"></p>
...
<ul>
<li>
<p><RouterLink to="/mit-6-824/">Ⓜ️回到目录🏠</RouterLink></p>
</li>
<li>
