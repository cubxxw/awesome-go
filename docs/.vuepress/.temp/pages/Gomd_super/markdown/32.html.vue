<template><div><h1 id="_1-hash表" tabindex="-1"><a class="header-anchor" href="#_1-hash表" aria-hidden="true">#</a> 1. Hash表</h1>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>    127.0.0.1:6379> hget books abc
    "100"
