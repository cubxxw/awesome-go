<template><div><h1 id="_1-kafka介绍" tabindex="-1"><a class="header-anchor" href="#_1-kafka介绍" aria-hidden="true">#</a> 1. Kafka介绍</h1>
<h3 id="_1-1-1-kafka是什么" tabindex="-1"><a class="header-anchor" href="#_1-1-1-kafka是什么" aria-hidden="true">#</a> 1.1.1. Kafka是什么</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>    kafka使用scala开发，支持多语言客户端（c++、java、python、go等）
    ...
    支持online和offline的场景
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-2-kafka的特点" tabindex="-1"><a class="header-anchor" href="#_1-1-2-kafka的特点" aria-hidden="true">#</a> 1.1.2. Kafka的特点</h3>
<p>Kafka是分布式的，其所有的构件borker(服务端集群)、producer(消息生产)、consumer(消息消费者)都可以是分布式的。</p>
...
<h3 id="_1-1-3-常用的场景" tabindex="-1"><a class="header-anchor" href="#_1-1-3-常用的场景" aria-hidden="true">#</a> 1.1.3. 常用的场景</h3>
<p>监控：主机通过Kafka发送与系统和应用程序健康相关的指标，然后这些信息会被收集和处理从而创建监控仪表盘并发送警告。</p>
...
<h3 id="_1-1-4-kafka中包含以下基础概念" tabindex="-1"><a class="header-anchor" href="#_1-1-4-kafka中包含以下基础概念" aria-hidden="true">#</a> 1.1.4. Kafka中包含以下基础概念</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>    1.Topic(话题)：Kafka中用于区分不同类别信息的类别名称。由producer指定
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-1-5-消息" tabindex="-1"><a class="header-anchor" href="#_1-1-5-消息" aria-hidden="true">#</a> 1.1.5. 消息</h3>
<p>消息由一个固定大小的报头和可变长度但不透明的字节阵列负载。报头包含格式版本和CRC32效验和以检测损坏或截断</p>
<h3 id="_1-1-6-消息格式" tabindex="-1"><a class="header-anchor" href="#_1-1-6-消息格式" aria-hidden="true">#</a> 1.1.6. 消息格式</h3>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>    1. 4 byte CRC32 of the message
