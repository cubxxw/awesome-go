...
<hr>
<h1 id="查找算法" tabindex="-1"><a class="header-anchor" href="#查找算法" aria-hidden="true">#</a> 查找算法</h1>
...
<ul>
<li>[x] <RouterLink to="/go-advancend/markdown/8.html">Golang排序和查找</RouterLink></li>
<li>[x] <RouterLink to="/go-advancend/markdown/30.html">排序算法</RouterLink></li>
</ul>
