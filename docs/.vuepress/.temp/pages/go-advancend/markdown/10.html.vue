...
<p><img src="http://sm.nsddd.top/smimage-20221013231933876.png?xxw@nsddd.top" alt="image-20221013231933876"></p>
...
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 会执行 ./tmp/main bench</span>
air bench

<span class="token comment"># 会执行 ./tmp/main server --port 8080</span>
air server <span class="token parameter variable">--port</span> <span class="token number">8080</span>
...
<p>请注意：这需要 <code v-pre>Go 1.16+</code> ，因为我使用 <code v-pre>go mod</code> 来管理依赖。</p>
