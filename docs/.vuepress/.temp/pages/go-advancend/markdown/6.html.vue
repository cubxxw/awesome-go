...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/go-advancend/markdown/images/image-20221003140115396.png" alt="image-20221003140115396"></p>
<h2 id="闭包" tabindex="-1"><a class="header-anchor" href="#闭包" aria-hidden="true">#</a> 闭包</h2>
<p><strong>闭包就是一个==函数与相关的引用环境==组成的一个<u>整体（实体</u>）</strong></p>
...
<p>💡简单的一个案例如下：</p>
<p><img src="@source/go-advancend/markdown/images/4lTbFmDxeBMI8E9.png" alt="image-20220109141602331"></p>
...
<p><img src="@source/go-advancend/markdown/images/image-20221002155239446.png" alt="image-20221002155239446"></p>
...
<p><img src="@source/go-advancend/markdown/images/SebIThU4GB3xXCH.png" alt="image-20220109151948003"></p>
</li>
</ol>
...
<p>每隔0.1秒打印一个数字，打印5秒退出**（不可以使用time.Second * 0.1,编译不能通过，只能用millisecond(毫秒) * 100)**</p>
</blockquote>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
<span class="token keyword">import</span> <span class="token punctuation">(</span>
    <span class="token string">"fmt"</span>
...
j <span class="token operator">:=</span> <span class="token number">0</span>
 ...
 <span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/go-advancend/markdown/images/kQdxJsaft5wM4nB.png" alt="image-20220109154141855"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/go-advancend/markdown/images/nwSfaEKBhON96gD.png" alt="image-20220109160542484"></p>
<p>⚠️ func (Time) <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/time/time.go;l=1134" target="_blank" rel="noopener noreferrer">Unix<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/time@go1.17.6#Time.Unix" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a></p>
...
<p>⚠️func (Time) <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/time/time.go;l=1152" target="_blank" rel="noopener noreferrer">UnixMicro<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/time@go1.17.6#Time.UnixMicro" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a>added in go1.17</p>
...
<p>⚠️func (Time) <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/time/time.go;l=1143" target="_blank" rel="noopener noreferrer">UnixMilli<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/time@go1.17.6#Time.UnixMilli" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a>added in go1.17</p>
...
<p>⚠️func (Time) <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/time/time.go;l=1162" target="_blank" rel="noopener noreferrer">UnixNano<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/time@go1.17.6#Time.UnixNano" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a></p>
...
<p><img src="images/image-20221002163103950.png" alt="image-20221002163103950"></p>
<h2 id="golang内置函数" tabindex="-1"><a class="header-anchor" href="#golang内置函数" aria-hidden="true">#</a> Golang内置函数</h2>
<p>Golang地址：<a href="https://pkg.go.dev/builtin@go1.17.6" target="_blank" rel="noopener noreferrer">https://pkg.go.dev/builtin@go1.17.6<ExternalLinkIcon/></a></p>
<p>⚠️ func <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/builtin/builtin.go;l=194" target="_blank" rel="noopener noreferrer">new<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/builtin@go1.17.6#new" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a></p>
...
<p>在go语言中，make和new都是内存的分配（堆上），但是make只用于slice、map以及channel的初始化（非零值）；而new用于类型的内存分配，并且内存置为零。make返回的是引用类型本身；而new返回的是指向类型的指针。</p>
</blockquote>
...
<p><strong>Go中可以抛出一个<code v-pre>panic</code>的异常，然后在<code v-pre>defer</code>中通过recover捕获这个异常，然后正常处理</strong></p>
<p>使用<code v-pre>defer</code>和<code v-pre>recover</code>来处理异常。</p>
<p>⚠️func <a href="https://cs.opensource.google/go/go/+/go1.17.6:src/builtin/builtin.go;l=232" target="_blank" rel="noopener noreferrer">panic<ExternalLinkIcon/></a> <a href="https://pkg.go.dev/builtin@go1.17.6#panic" target="_blank" rel="noopener noreferrer">¶<ExternalLinkIcon/></a></p>
<p><strong>panic内置函数接受一个interface{}类型的值作为参数,可以接收error类型变量，输出错误信息，并退出程序</strong></p>
...
<p>函数读取init.config信息，如果文件名传入不正确，返回一个自定义错误</p>
</blockquote>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token keyword">package</span> main
<span class="token keyword">import</span> <span class="token punctuation">(</span>
	<span class="token string">"fmt"</span>
